function [sys,x0,str,ts,simStateCompliance] = mav_dynamics(t,x,u,flag,P, reset)
...
%     rdot = P.r7*p*q-P.r1*q*r+P.r4*ell+P.r8*n;
    pdot = ((P.Jy - P.Jz)*q*r+ell)/P.Jx;
    qdot = ((P.Jz - P.Jx)*p*r+m)/P.Jy;
    rdot = ((P.Jx - P.Jy)*p*q+n)/P.Jz;
